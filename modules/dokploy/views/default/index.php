...
<div class="w-full h-full bg-slate-950 overflow-hidden relative transition-all duration-300"
    ...
    <div class="absolute top-4 right-4 z-50 flex items-center gap-2 select-none">
        <div class="bg-slate-900/90 backdrop-blur-md border border-slate-800/80 rounded-xl p-1.5 shadow-2xl flex items-center gap-1.5">
            <!-- Botão: Copiar URL -->
            <button @click="copyUrl()" 
                ...
                <!-- Tooltip Feedback -->
                <span class="absolute bottom-full mb-2 left-1/2 -translate-x-1/2 px-2.5 py-1 text-[10px] font-bold text-slate-100 bg-slate-950/95 border border-slate-800/80 rounded-md shadow-xl transition-all duration-200 whitespace-nowrap pointer-events-none"
                      :class="copied ? 'opacity-100 scale-100' : 'opacity-0 scale-95 group-hover:opacity-100 group-hover:scale-100'"
